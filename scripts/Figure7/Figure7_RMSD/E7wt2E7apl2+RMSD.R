...
# 2. 读取文件 (无视原本错误的第一列)
wt_data <- read.table("E7wt2_10mer_rmsd.dat", col.names = c("Fake_Time", "RMSD"))
apl_data <- read.table("E7apl2_10mer_rmsd.dat", col.names = c("Fake_Time", "RMSD"))
...
out <- "Figure_RMSD_50ns_E7wt2_E7apl2_v1"
