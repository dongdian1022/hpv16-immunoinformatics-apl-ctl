# ==========================================
# 结构免疫学 MD 数据可视化：多肽 RMSF 柔性对比 (E6 10-mer)
# (极简纯净版：完美对齐 20-50ns 数据与系列视觉风格)
# ==========================================
...
wt_data <- read.table("E6wt_10mer_rmsf_20_50ns_v3.dat", col.names = c("Residue", "RMSF"))
apl_data <- read.table("E6apl_10mer_rmsf_20_50ns_v3.dat", col.names = c("Residue", "RMSF"))
...
p <- ggplot(merged_data, aes(x = Position, y = RMSF, color = Group, group = Group)) +
  ...
  # 🚨 魔法 1：复刻完美的 L 型黑线 (10-mer 延伸到 10.5)
...
# 6. 统一格式与尺寸导出
out <- "Figure_RMSF_20_50ns_E6wt_E6apl_v1"
